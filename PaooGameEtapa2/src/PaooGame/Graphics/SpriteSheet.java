...
public class SpriteSheet
{
    ...
    {
        return spriteSheet.getSubimage(x, y, Assets.defaultWidth, Assets.defaultHight);
    }
    public BufferedImage cropAttack(int x, int y)
    {
        return spriteSheet.getSubimage(x, y, Assets.defaultWidthAttack, Assets.defaultHightAttack);
    }
